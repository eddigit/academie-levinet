...
const DisciplineWKMOPage = () => {
  ...
  const discImage = content?.disciplines?.wkmo?.hero_image || content?.disciplines?.wkmo?.image || '/images/grand-public.jpeg';
  ...
  const discLogoImage = content?.disciplines?.wkmo?.logo_image || '/images/logo-levinet.jpeg';
